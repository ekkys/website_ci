  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url();?>" class="logo">
        ...
        <span class="logo-lg"><b>Curhatan</b>Coding</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <b><?php echo $this->session->userdata('level'); ?></b>
              </a>
    ...
    <aside class="main-sidebar">
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Practice</b> Membuat Website Sendiri dari Nol sampai ONLINE Dengan Codeigniter
        </div>
        <strong>Copyright &copy; <?php  echo date('Y') ?> <a href="https://adminlte.io">CurhatanKoding.</a>.</strong> All rights
        reserved.
      </footer>
      <!-- ./wrapper -->

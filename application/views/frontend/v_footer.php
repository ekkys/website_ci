			...
			<div class="row">
				<div class="col-sm-12">
					<div class="copyright-box">
						<div class="socials">
							<ul>
								<li><a href="<?php echo $pengaturan->link_facebook ?>"><span class="ico-circle"><i class="ionsocial-facebook"></i></span></a></li>
								<li><a href="<?php echo $pengaturan->link_instagram ?>"><span class="ico-circle"><i class="ion-social-instagram"></i></span></a></li>
								<li><a href="<?php echo $pengaturan->link_twitter ?>"><span class="ico-circle"><i class="ionsocial-twitter"></i></span></a></li>
								<li><a href="<?php echo $pengaturan->link_github ?>"><span class="ico-circle"><i class="ionsocial-github"></i></span></a></li>
							</ul>
						</div>

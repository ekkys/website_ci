		...
		<div class="row">
			<div class="col-lg-12">
				<a href="<?php echo base_url().'dashboard/pages_tambah'; ?>"
					class="btn btn-sm btn-primary">Buat halaman baru</a><br/>
					<br/>
								...
								<tbody>
									...
									foreach($halaman as $h){
										...
										<tr>
											...
											<td>
												<a
												target="_blank" href="<?php echo base_url()."page/".$h->halaman_slug; ?>" class="btn btn-success btnsm"> <i class="fa fa-eye"></i> </a>
												<a
												href="<?php echo base_url().'dashboard/pages_edit/'.$h->halaman_id; ?>" class="btn btn-warning btn-sm">
												<i class="fa fa-pencil"></i> </a>
												<a
												href="<?php echo base_url().'dashboard/pages_hapus/'.$h->halaman_id; ?>" class="btn btn-danger btnsm"> <i class="fa fa-trash"></i> </a>
											</td>
										</tr>
									<?php } ?>
								</tbody>

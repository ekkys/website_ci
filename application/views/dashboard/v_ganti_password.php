					...
					<div class="box-body">
						...
						if (isset($_GET['alert'])) {
							if ($_GET['alert'] == "sukses") {
								...
								echo "<div class='alert alert-danger'>Maaf, Password yang anda masukkan salah!</div>";	
							}
						}
						?>
						...
						<form method="post" action="<?php echo base_url('dashboard/ganti_password_aksi'); ?>">
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text" name="password_lama" class="form-control" placeholder="Masukkan Password Lama Anda..">
									<?php echo form_error('password_lama');?>
								</div>

								<div class="form-group">
									<label>Password Baru</label>
									<input type="text" name="password_baru" class="form-control" placeholder="Masukkan Password Baru Anda">
									<?php echo form_error('password_baru'); ?>
								</div>

								<div class="form-group">
									<label>Konfirmasi Password Baru</label>
									<input type="text" name="konfirmasi_password" class="form-control" placeholder="Ulangi Password Baru..">

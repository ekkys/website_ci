						...
						<?php foreach($pengaturan as $p){ ?>
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<input type="text"
									name="deskripsi" class="form-control" placeholder="Masukkan deskripsi .." value="<?php echo $p->deskripsi; ?>">
								...
								<div class="form-group">
									...
									<input type="text"
									name="link_facebook" class="form-control" placeholder="Masukkan link facebook .." value="<?php echo $p->link_facebook; ?>">
